...
digraph process {
    ...
    "Final review clean: delete this plan's workspace" -> "Use skillful:finishing-a-development-branch";
}
```
...
skillful:using-git-worktrees to create one or verify the existing one.
...
skillful:requesting-code-review's
...
Use skillful:finishing-a-development-branch.
...
[Resolve workspace: scripts/sdd-workspace docs/skillful/plans/feature-plan.md — no ledger inside, fresh start]
...
Done! Using skillful:finishing-a-development-branch.
```
...
- [re-review-prompt.md](re-review-prompt.md) - Dispatch scoped re-review after fix round
